...
OpenCV comes with three algorithms for recognizing faces: Eigenfaces, Fisherfaces and Local Binary Patterns Histograms (LBPH). The demo app uses an LBPH classifier to recognize faces. 
