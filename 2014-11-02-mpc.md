...
Other examples in this article will be taken from [PeerKit][peerkit], an open-source Swift framework for building event-driven, zero-config MPC apps.
...
See CardsAgainst's [ConnectionManager.swift source](https://github.com/jpsim/CardsAgainst/blob/master/CardsAgainst/ConnectionManager.swift) for more information.
