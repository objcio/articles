...
Metal is a highly optimized framework for programming the GPUs found in iPhones and iPads. The name "Metal" derives from the fact that Metal is the lowest-level graphics framework on the iOS platform (i.e., it is "closest to the metal").
