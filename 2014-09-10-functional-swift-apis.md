...
Translating the generic types `A`, `B`, and `C` in our mind to all represent `CIImage` makes it clear that the generic operator is indeed capable of replacing the specific filter composition operator.     
