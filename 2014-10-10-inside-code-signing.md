...
The reason for using CMS is that a provisioning profile is signed itself. This signature is not the same as the code signature of the app itself. Instead, it is signed directly by Apple after being generated by the developer portal.
