...
BDD DSL inherits its syntax from RSpec[^1], a Ruby BDD framework. Here's a simple example of how it looks like:
...
If you wish to learn more about RSpec syntax you should check out [Specta guide for writing specs](https://github.com/specta/specta#writing-specs).
