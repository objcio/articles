...
Specta, Kiwi and Cedar have nearly the same syntax, the main difference between them lies in their configurability and other bundled components. 
...
My personal prefference when it comes to BDD frameworks is Specta. 

There are also two BDD frameworks that are dedicated to Swift:
