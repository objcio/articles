...
With the above example, it is clear that you do not have to record the exact sound in order to get an approximation of it for your game, and sometimes it's even the better choice. One great example of a time when you would not want to use the direct sound source is when you have a gunshot. If you have ever heard a real gun shooting, you might have realized that it counterintuitively sounds fake. <Find out what people actually use for a gun shot.>
